      ...
      <div className="max-w-7xl mx-auto">
          ...
          {skillCategories.map((category, index) => (
            ...
            >
              <div className="text-center mb-6 md:mb-8">
                ...
                <h3 className="text-lg md:text-xl lg:text-2xl font-bold text-slate-800 dark:text-slate-100">{category.title}</h3>
              </div>
                ...
                {category.skills.map((skill) => (
                  <div key={skill.name}>
                    <div className="flex justify-between items-center mb-2">
                      <span className="font-medium text-slate-700 dark:text-slate-200 text-sm md:text-base">{skill.name}</span>
        ...
        <div className="mt-10 md:mt-16 fade-in">
          <div className="glass-effect rounded-2xl p-6 md:p-8 card-shadow">
            <h3 className="text-xl md:text-2xl font-bold text-slate-800 dark:text-slate-100 mb-6 md:text-center">Additional Technologies & Tools</h3>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 md:gap-6">
              {[
                ...
                <div
                  key={tool}
                  className={`bg-gradient-to-r from-slate-100 to-slate-200 dark:from-slate-800 dark:to-slate-700 text-slate-800 dark:text-slate-100 px-3 py-2 md:px-4 md:py-3 rounded-xl text-center font-medium hover-shimmer cursor-pointer text-xs md:text-sm ${
