      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            ...
            <div className="glass-effect rounded-2xl p-6 md:p-8 card-shadow">
              ...
              <form onSubmit={submitHandler} className="space-y-4 md:space-y-6">
                ...
                {submitStatus === 'success' && (
                  <div className="bg-green-50 border border-green-200 rounded-xl p-4 mb-4 md:mb-6">
                    <div className="flex items-center">
                      <span className="text-green-500 text-xl mr-3">✓</span>
                      <p className="text-green-800 font-medium text-sm md:text-base">Message sent successfully! I'll get back to you soon.</p>
                    </div>
                  </div>
                )}

                {submitStatus === 'error' && (
                  <div className="bg-red-50 border border-red-200 rounded-xl p-4 mb-4 md:mb-6">
                    <div className="flex items-center">
                      <span className="text-red-500 text-xl mr-3">✕</span>
                      <p className="text-red-800 font-medium text-sm md:text-base">Failed to send message. Please try again or contact me directly.</p>
                    </div>
                  </div>
                )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-3 md:px-4 py-2 md:py-3 border rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 bg-white/50 backdrop-blur-sm ${
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={`w-full px-3 md:px-4 py-2 md:py-3 border rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 bg-white/50 backdrop-blur-sm resize-none ${
          ...
          <div className="space-y-4 md:space-y-6 fade-in-delayed">
              ...
              <div className="space-y-4 md:space-y-6">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm md:text-base">berihu@example.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm md:text-base">+251 911 123 456</p>
                  </div>
                </div>
            ...
            <div className="glass-effect rounded-2xl p-6 md:p-8 card-shadow">
              <h3 className="text-lg md:text-xl font-bold text-gray-800 mb-3 md:mb-4">Let's Connect</h3>
